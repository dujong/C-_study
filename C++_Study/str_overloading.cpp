...
//
//    int find(int find_from, const MyString& str, int N) const;
//    int find(int find_from, const char* str, int N) const;
//    int find(int find_from, char c, int N) const;
//
//
...
//    return *this;
//}
//int MyString::find(int find_from, const MyString& str, int N) const {
//
//    if (N == 0) {
//        int i, j;
...
//
//}
//int MyString::find(int find_from, const char* str, int N) const {
//    MyString temp(str);
//    return find(find_from, temp, N);
//}
//int MyString::find(int find_from, char c, int N) const {
//    MyString temp(c);
//    return find(find_from, temp, N);
//}
